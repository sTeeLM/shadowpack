...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "Configurations\\00-base-templates.conf", "Configurations\\10-main.conf", "Configurations\\50-masm.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
  ...
  perl_version => "5.28.1",
  perlargv => [ "no-shared", "VC-WIN64A-masm" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
