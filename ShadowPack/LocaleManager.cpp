...
CLocaleManager::LOCAL_TABLE_T CLocaleManager::m_LocalTable[] = {
    { LOCALE_CHINESE_SC, IDS_LOCALE_CHINESE_SC, LANG_CHINESE, SUBLANG_CHINESE_SIMPLIFIED, NULL, NULL },
    { LOCALE_ENGLISH_US, IDS_LOCALE_ENGLISH_US, LANG_ENGLISH, SUBLANG_ENGLISH_US, NULL, _T("lang\\langEnglishUS.dll") },
};
