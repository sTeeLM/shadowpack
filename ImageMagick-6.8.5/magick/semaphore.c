...
#endif
#ifdef _DEBUG
   _CrtDbgReport(_CRT_WARN, __FILE__, __LINE__, "Semaphore", "AcquireSemaphoreMemory %p\n", memory);
#endif
  return(memory);
}
...
{
#ifdef _DEBUG
   _CrtDbgReport(_CRT_WARN, __FILE__, __LINE__, "Semaphore","RelinquishSemaphoreMemory %p\n", memory);
#endif
